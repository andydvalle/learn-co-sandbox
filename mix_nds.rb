vending_machine = [[[{:name=>"Vanilla Cookies", :price=>3},
 ...
 [[{:name=>"Grape Drink", :price=>1},
  ...
  #puts vending_machine[0][1]
  #puts vending_machine[0][2]
  #puts vending_machine[1][0]
  #puts vending_machine[1][1]
  
  #enamel eaters hash 
  #puts vending_machine[0][1][2]
  
  #price of Gummy Apple 
  puts vending_machine[0][2][1][:price]